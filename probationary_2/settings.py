...
SECRET_KEY = "django-insecure-97!b9@+n-*$h3-mq44k0sxyau_c2p(4)z(&d7@v$po^*1_)hnw"
...
ROOT_URLCONF = "probationary_2.urls"
...
WSGI_APPLICATION = "probationary_2.wsgi.application"
